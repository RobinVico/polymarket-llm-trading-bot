...
/* v5.8: scan_all 状态徽章 (覆盖到 tier 配色之上) */
.tag-chip.chip-pending{opacity:0.5}
.tag-chip.chip-running{background:rgba(255,192,64,0.15);border-color:var(--am);color:var(--am);animation:chipPulse 1.2s ease-in-out infinite}
.tag-chip.chip-done{background:rgba(0,229,160,0.12);border-color:rgba(0,229,160,0.55);color:#00e5a0}
.tag-chip.chip-error{background:rgba(255,64,112,0.12);border-color:var(--rd);color:var(--rd)}
...
<button class="btn btn-primary" onclick="doScanAll()" id="scan-all-btn">🚀 一键扫 Tier 1+2 (27 tag)</button>
<button class="btn" onclick="doResetScanMarks()" title="清掉所有 chip 上的 ✓ / ⏳ / ❌ 标记 (缓存报告仍保留, 仍可点 chip 查看)">🔄 重置标记</button>
<span id="scan-all-progress" style="font-size:11px;color:var(--tx2);font-family:'JetBrains Mono'"></span>
<span style="font-size:10px;color:var(--tx3);margin-left:auto">点 🤖 复制后会自动清掉 ✓</span>
</div>
...
<span style="font-size:10px;color:var(--tx3);margin-left:auto">点tag chip单独扫</span>
</div>
...
<button class="tag-chip tier1" data-tag="Iran" onclick="doTagScan('Iran')">Iran</button>
<button class="tag-chip tier1" data-tag="Israel" onclick="doTagScan('Israel')">Israel</button>
<button class="tag-chip tier1" data-tag="Ukraine" onclick="doTagScan('Ukraine')">Ukraine</button>
<button class="tag-chip tier1" data-tag="Ukraine Peace Deal" onclick="doTagScan('Ukraine Peace Deal')">Ukraine Peace Deal</button>
<button class="tag-chip tier1" data-tag="Russia" onclick="doTagScan('Russia')">Russia</button>
<button class="tag-chip tier1" data-tag="China" onclick="doTagScan('China')">China</button>
<button class="tag-chip tier1" data-tag="Taiwan" onclick="doTagScan('Taiwan')">Taiwan</button>
<button class="tag-chip tier1" data-tag="Geopolitics" onclick="doTagScan('Geopolitics')">Geopolitics</button>
<button class="tag-chip tier1" data-tag="Middle East" onclick="doTagScan('Middle East')">Middle East</button>
<button class="tag-chip tier1" data-tag="World" onclick="doTagScan('World')">World</button>
<button class="tag-chip tier1" data-tag="Foreign Policy" onclick="doTagScan('Foreign Policy')">Foreign Policy</button>
<button class="tag-chip tier1" data-tag="Brazil" onclick="doTagScan('Brazil')">Brazil</button>
<button class="tag-chip tier1" data-tag="Mexico" onclick="doTagScan('Mexico')">Mexico</button>
<button class="tag-chip tier1" data-tag="Congress" onclick="doTagScan('Congress')">Congress</button>
<button class="tag-chip tier1" data-tag="Global Elections" onclick="doTagScan('Global Elections')">Global Elections</button>
</div>
...
<div style="display:flex;gap:6px;flex-wrap:wrap;margin-bottom:14px">
<button class="tag-chip tier2" data-tag="Trump" onclick="doTagScan('Trump')">Trump</button>
<button class="tag-chip tier2" data-tag="Trump Presidency" onclick="doTagScan('Trump Presidency')">Trump Presidency</button>
<button class="tag-chip tier2" data-tag="SCOTUS" onclick="doTagScan('SCOTUS')">SCOTUS</button>
<button class="tag-chip tier2" data-tag="Politics" onclick="doTagScan('Politics')">Politics</button>
<button class="tag-chip tier2" data-tag="US Politics" onclick="doTagScan('US Politics')">US Politics</button>
<button class="tag-chip tier2" data-tag="AI" onclick="doTagScan('AI')">AI</button>
<button class="tag-chip tier2" data-tag="OpenAI" onclick="doTagScan('OpenAI')">OpenAI</button>
<button class="tag-chip tier2" data-tag="Tech" onclick="doTagScan('Tech')">Tech</button>
<button class="tag-chip tier2" data-tag="Science" onclick="doTagScan('Science')">Science</button>
<button class="tag-chip tier2" data-tag="Venezuela" onclick="doTagScan('Venezuela')">Venezuela</button>
<button class="tag-chip tier2" data-tag="SpaceX" onclick="doTagScan('SpaceX')">SpaceX</button>
<button class="tag-chip tier2" data-tag="Primaries" onclick="doTagScan('Primaries')">Primaries</button>
</div>
...
<div style="display:flex;gap:6px;flex-wrap:wrap;margin-bottom:14px">
<button class="tag-chip tier3" data-tag="Awards" onclick="doTagScan('Awards')">Awards</button>
<button class="tag-chip tier3" data-tag="Pop Culture" onclick="doTagScan('Pop Culture')">Pop Culture</button>
<button class="tag-chip tier3" data-tag="Eurovision" onclick="doTagScan('Eurovision')">Eurovision</button>
</div>
...
<div style="display:flex;gap:6px;flex-wrap:wrap;margin-bottom:14px">
<button class="tag-chip tier4" data-tag="FDA" onclick="doTagScan('FDA')">FDA</button>
<button class="tag-chip tier4" data-tag="Immigration" onclick="doTagScan('Immigration')">Immigration</button>
<button class="tag-chip tier4" data-tag="Argentina" onclick="doTagScan('Argentina')">Argentina</button>
<button class="tag-chip tier4" data-tag="Germany" onclick="doTagScan('Germany')">Germany</button>
<button class="tag-chip tier4" data-tag="France" onclick="doTagScan('France')">France</button>
<button class="tag-chip tier4" data-tag="Box Office" onclick="doTagScan('Box Office')">Box Office</button>
<button class="tag-chip tier4" data-tag="Olympics" onclick="doTagScan('Olympics')">Olympics</button>
<button class="tag-chip tier4" data-tag="Nobel Peace Prize" onclick="doTagScan('Nobel Peace Prize')">Nobel Peace Prize</button>
<button class="tag-chip tier4" data-tag="OPEC" onclick="doTagScan('OPEC')">OPEC</button>
</div>
...
<!-- v5.8 增量: 持仓 tab 切换 (当前持仓 / 重评模式) -->
<div class="pos-tabs">
<button class="pos-tab pos-tab-active" id="ptab-current" onclick="switchPosTab('current')">📦 当前持仓</button>
...
// v5.8: tag label -> filename slug (mirror _slugify_tag in scanner.py)
function slugifyTag(label){return label.toLowerCase().replace(/ /g,'-').replace(/\//g,'-')}

// v5.8: 给 chip 加状态 (emoji 后缀 + class). 在 chip textContent 末尾加 emoji.
function setChipStatus(slug, status){
  // 遍历 chip 找匹配的 slug (chip 自己只有 data-tag/label, JS 端 slugify)
  const chips=document.querySelectorAll('.tag-chip[data-tag]');
  for(const chip of chips){
    const label=chip.getAttribute('data-tag');
    if(slugifyTag(label)!==slug)continue;
    chip.classList.remove('chip-pending','chip-running','chip-done','chip-error');
    const emojiMap={'pending':' ⏳','running':' 🔄','done':' ✓','error':' ❌'};
    chip.textContent=label+(emojiMap[status]||'');
    if(status)chip.classList.add('chip-'+status);
    return;
  }
}

// v5.8 增量: 全部清掉 chip 标记 (缓存仍保留)
function doResetScanMarks(){
  const chips=document.querySelectorAll('.tag-chip[data-tag]');
  let n=0;
  chips.forEach(chip=>{
    if(chip.classList.contains('chip-pending')||chip.classList.contains('chip-running')||chip.classList.contains('chip-done')||chip.classList.contains('chip-error')){
      chip.classList.remove('chip-pending','chip-running','chip-done','chip-error');
      chip.textContent=chip.getAttribute('data-tag');
      n++;
    }
  });
  document.getElementById('scan-all-progress').textContent='';
  showT('ok','已重置 '+n+' 个标记 (缓存还在, 仍可点 chip 看)');
}
...
function doScanAll(){
  ...
  fetch('/api/scan_all',{method:'POST',headers:{'Content-Type':'application/json'},
    body:JSON.stringify({tiers:[1,2], mode:mode})})
    .then(r=>r.json()).then(d=>{
      if(!d.ok){showT('err',d.message||'启动失败');btn.disabled=false;btn.textContent='🚀 一键扫 Tier 1+2 (27 tag)';return}
      showT('ok',d.message);
      pollScanAll(0);
    }).catch(()=>{showT('err','启动失败');btn.disabled=false;btn.textContent='🚀 一键扫 Tier 1+2 (27 tag)'})
}

// v5.8: 轮询 scan_all 进度
function pollScanAll(attempt){
  fetch('/api/scan_all_status').then(r=>r.json()).then(d=>{
    if(!d.ok)return;
    const s=d.summary||{};
    const total=s.total||0, done=s.done||0, running=s.running||0, pending=s.pending||0, err=s.error||0;
    document.getElementById('scan-all-progress').textContent=
      '完成 '+done+'/'+total+' | 进行中 '+running+' | 待扫 '+pending+(err>0?(' | 失败 '+err):'');
    // 更新每个 chip 状态
    Object.keys(d.manifest||{}).forEach(slug=>{
      setChipStatus(slug, d.manifest[slug].status);
    });
    if(done+err>=total && total>0){
      const btn=document.getElementById('scan-all-btn');
      btn.disabled=false; btn.textContent='🚀 重扫 Tier 1+2 (27 tag)';
      showT('ok','全扫完成! 点 chip 看缓存');
      return;
    }
    if(attempt>=300){showT('err','轮询超时');return}
    setTimeout(()=>pollScanAll(attempt+1),2000);
  }).catch(()=>setTimeout(()=>pollScanAll(attempt+1),2000))
}

function doTagScan(tagLabel){
  // v5.8: 先查 cache. 如果已 cached 且不是 force, 直接读 (零等)
  const slug=slugifyTag(tagLabel);
  const chip=document.querySelector('.tag-chip[data-tag="'+tagLabel+'"]');
  const isCached=chip && chip.classList.contains('chip-done');
  if(isCached){
    fetch('/api/scan_report?tag='+encodeURIComponent(tagLabel)).then(r=>r.json()).then(d=>{
      if(d.ok){
        document.getElementById('scanReport').textContent=d.report;
        const dt=d.mtime?new Date(d.mtime*1000):null;
        document.getElementById('tagScanStatus').textContent='📦 缓存 ['+tagLabel+']'+(dt?' '+dt.toLocaleTimeString():'');
        // 标记当前看的是哪个 tag (给 copyP 用)
        document.getElementById('scanReport').setAttribute('data-current-tag', tagLabel);
        showT('ok','切换到 '+tagLabel+' (缓存)');
      } else {showT('err',d.report||'缓存读取失败')}
    });
    return;
  }
  // 未 cached → 走旧串行扫
...
function switchPosTab(name){
  ...
  const cur=document.getElementById('pos-panel-current');
  const rv=document.getElementById('pos-panel-reeval');
  if(name==='reeval'){ if(cur)cur.style.display='none'; if(rv)rv.style.display=''; }
  else { if(cur)cur.style.display=''; if(rv)rv.style.display='none'; }
}
...
async function copyP(){
  // v5.8: 如果 scanReport 上有 data-current-tag, 复制该 tag 的 prompt; 否则全报告 prompt
  const cur=document.getElementById('scanReport').getAttribute('data-current-tag');
  showT('ok','正在准备最新Prompt...');
  try{
    const url=cur?('/api/full_prompt?tag='+encodeURIComponent(cur)):'/api/full_prompt';
    ...
    // v5.8 增量: 复制成功后, 把当前 tag 的 chip 状态清掉 (从 ✓ 变回原样, 表示"已处理过这个")
    if(cur){ setChipStatus(slugifyTag(cur), ''); }
    showT('ok','✅ Prompt 已复制'+(cur?(' ['+cur+']'):'')+'! 去 Claude.ai 粘贴');
  }catch(e){
